    ...
    <div className={styles.home} data-theme={theme}>
      ...
      <main className={styles.container}>
        ...
        >
          ...
          <p>
            <span>
              A sua privacidade é importante para nós. É política do RASG
              respeitar a sua privacidade em relação a qualquer informação sua
              que possamos coletar no site{' '}
              <a href="https://app.rasg.com.br">RASG</a>, e outros sites que
          ...
          <p>
            <span>
              ...
              informação que o RASG oferece no site e com caráter enunciativo,
              mas não limitativo:
            </span>
          </p>
          <ul style={{ marginLeft: '2.5rem' }}>
            ...
            <li>
              <span>
                ...
                (softwares) do RASG, de seus fornecedores ou terceiros, para
          ...
          <p>
            <span>
              Esta política é efetiva a partir de&nbsp;23 Dezembro 2022.
            </span>
          </p>
        </div>
      </main>
